...
class Application:
    ...
    def __init__(self):
        ...
        self.model = load_model('C:\\Users\\chikki\\Desktop\\SignToText\\SignToText\\cnn8grps_rad1_model.h5')
        ...
        self.T1.config(text=" :", font=("Courier", 30, "bold"))
    ...
    def video_loop(self):     
        try:
            ...
            if hands:
                ...
                white = cv2.imread("C:\\Users\\chikki\\Desktop\\SignToText\\SignToText\white.jpg")
